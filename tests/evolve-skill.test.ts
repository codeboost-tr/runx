...
describe("evolve skill", () => {
  it("runs as one bundled skill with inline run steps and a shared journal", async () => {
    ...
    try {
      ...
      const exitCode = await runCli(
        ["evolve", "add release notes", "--answers", answersPath, "--receipt-dir", receiptDir, "--non-interactive", "--json"],
